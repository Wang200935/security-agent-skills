...
public:
  ...
  // This is the ONLY working TX method for interference. See rfclown-multi-protocol-jammer/references/nrf24-tx-mode-truth.md
...
Full analysis + verification data: see `rfclown-multi-protocol-jammer/references/nrf24-tx-mode-truth.md`
...
**Result**: constCarrier is the ONLY working method. Verified empirically — see `rfclown-multi-protocol-jammer/references/nrf24-tx-mode-truth.md` for STATUS/FIFO observation data.
