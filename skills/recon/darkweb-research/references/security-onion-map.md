...
**來源方法**: Ahmia 全 8259 URL 索引 → keyword scan (exploit/CTF/malware/forum/mirror/leaks/advanced-pentest 等) → 取活站 → 抓 Java stripped 純文字 → 鑑定。全部經 Tor SOCKS5 127.0.0.1:9050 + socks5h。
...
Tor Project 核心維護者。blog + talks + 攝影,主題: free/open source、infosec、hardware hardening、cryptography-fundamentals、privacy enhancing tech、network protocols、distributed systems、Erlang、C/C++/Rust。
...
KW = ['exploit','cve','zero day','payload','shellcode','metasploit','rat','rootkit',
      'advanced-pentest','red team','hackerone','bug bounty','offensive','ethical hacker',
      ...
      'osint-framework','shodan','recon','reverse dns',
