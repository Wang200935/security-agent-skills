...
### Track 2: username-scanner (username: wheat20131)
...
2. **username-scanner "high probability" does NOT mean "real account"**: TryHackMe at 0.93 was a rate-limit page, Chatujme.cz at 0.93 had "neexistuje" (doesn't exist) in the title. Manual verification is mandatory.
