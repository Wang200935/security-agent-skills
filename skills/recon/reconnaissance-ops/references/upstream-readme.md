...
- **20 个渗透 Skill** — 7 核心 + 13 专项 Skill（含 CTF Web/Crypto/Misc + osint-recon-model），含 138 个参考文档
...
| Skill             | 说明               |
| ----------------- | ------------------ |
| advanced-pentest-flow      | 渗透测试全流程编排 |
| recon             | 信息收集流程       |
...
| Skill                     | 参考文档数 | 说明                                         |
| ------------------------- | ---------- | -------------------------------------------- |
| web-advanced-pentest               | 4          | Web 应用渗透                                 |
...
| advanced-pentest-tools             | 18         | 渗透工具速查                                 |
...
| **ctf-misc-toolkit**              | 6          | CTF 杂项知识库（PyJail/BashJail/编码链/VM逆向） |
| **osint-recon-model**           | 7          | OSINT 开源情报收集（四维模型：服务器/网站/域名/人员） |
...
| v0.1.3   | 四维信息收集模型 + RECON_MIN_ROUNDS + 维度完成度自检 + 社工条件触发 + osint-recon-model Skill | ✅ 已完成 |
...
| ![VulnClaw 产品体验交流群](assets/VulnClaw产品体验交流群.jpg) | ![VulnClaw 开发者群聊](assets/VulnClaw开发者群聊.png) |
| **QQ 群号：680166726** | **QQ 群号：1065858551** |
